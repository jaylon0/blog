...
//    }
    ...
    private String uploadFile(String filePath, InputStream inputStream) {
        ...
        String accessKeyId = "nVcqVxpVRlPTrO1xERBjevmmSlMUm6--M1h16LYX";
        String accessKeySecret = "al2KHFRp_WCoIfQn0O-gQt6kOYet21GUkUw7lbjf";
        String bucketName = "jaylonyuan";
        // 创建OSSClient实例。
    ...
    private String uploadOss(MultipartFile imgFile, String filePath) {
        ...
        try {
            ...
            try {
                ...
                System.out.println(putRet.key);
                System.out.println(putRet.hash);
                return "http://ruuqg4lm4.hn-bkt.clouddn.com/" + key;
            } catch (QiniuException ex) {
                Response r = ex.response;
                System.err.println(r.toString());
                try {
